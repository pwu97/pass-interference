## Follow instructions as in `10-15-20-penalties.R` 

## Idea is to get density plots for 10, 15, and 20 yard
## penalties. We first filter for pass lengths >= 10 yards,
## and then mutate those to 10, 15, 20 yards to see the
## new density plots. We use these plots as our exploratory
## data analysis in our report
